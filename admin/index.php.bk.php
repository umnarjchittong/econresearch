    ...
    <main class="mb-3">
        <div class="container mx-auto py-3">
            ...
            if (isset($_GET['p']) && $_GET['p'] != '') {
                ...
                //echo '<img src="' . $_SESSION["admin"]["personnelPhoto"] . '" width="200px">';
                // echo $_SESSION["admin"]["personnelPhoto"] . "<br>";
                // str_replace("http://", "https://", $_SESSION["admin"]["personnelPhoto"]);
            ?>
                <div class="row">
                    <div class="col-3 text-center">
                        <img src="<?= $_SESSION["admin"]["personnelPhoto"] ?>" class="img-thumbnail rounded rounded-3 w-50 mx-auto" alt="">
                    </div>
                    <div class="col-auto pt-3">
                        <h2><?= $_SESSION["admin"]["titlePosition"] . " " . $_SESSION["admin"]["firstName"] . "  " . $_SESSION["admin"]["lastName"] ?></h2>
                        <h3><?= $_SESSION["admin"]["titleNameEn"] . " " . $_SESSION["admin"]["firstName_en"] . "  " . $_SESSION["admin"]["lastName_en"] ?></h3>
                        <h3><?= "สิทธิ์การเข้าถึง : ระดับ" . $fnc->system_auth_lv[$_SESSION["admin"]["auth_lv"]] ?></h3>
                    </div>
                </div>

            <?PHP
                echo "<br><hr><br>Your Contents...";
                echo 'SELECT SUM(`res_budget`) AS SumBudget FROM `research` WHERE `res_fiscalyear` = 2565';
            }
            ?>
