...
// * reseach function
class research_fnc extends general_fnc
{
                ...
                <div class="card-footer text-end">
                    ...
                    <div class="row px-3 gx-3 mt-3">
                        <div class="col-6 col-md-3 offset-md-6">
                            <button type="button" class="btn btn-secondary w-100 py-2 text-uppercase" onclick="window.location='?p=research'">close</button>
                        </div>
    ...
    {
        $fnc = new web;
        $sql = "SELECT * FROM `research` WHERE `jour_id` = " . $jour_id;
        ...
        <div class="card p-0 p-md-3 box_shadow">
            ...
            <form action="../db_mgt.php" method="post" autocomplete="off">
                ...
                <div class="card-footer text-end">
                    ...
                    <div class="row px-3 gx-3 mt-3">
                        <div class="col-6 col-md-3 offset-md-6">
                            <button type="button" class="btn btn-outline-secondary w-100 py-2 text-uppercase" onclick="window.open('../admin/?p=research&act=viewinfo&jid=<?= $jour_id ?>','_top');">close</button>
                        </div>
                        <div class="col-6 col-md-3">
        ...
        ?>
            <tr>
                ...
                <td class="d-none d-md-table-cell" nowrap><?php
                                                            if ($linkable) {
                                                                echo '<a href="?p=research&find=memberId&k=' . $row["jour_owner_citizenid"] . '" target="_top" class="fw-bold">' . $fnc->gen_titlePosition_short($row["jour_owner_prename"]) . $row["jour_owner_firstname"] . ' ' . $row["jour_owner_lastname"] . '</a>';
                                                            } else {
                                                                echo $fnc->gen_titlePosition_short($row["jour_owner_prename"]) . $row["jour_owner_firstname"] . ' ' . $row["jour_owner_lastname"];
                                                            }
                                                            ?>
                    <?php
                    $sql = "SELECT * FROM `co_worker` WHERE `cow_status` = 'enable' AND `cow_ref_table` = 'research' AND `cow_ref_id` = " . $row["jour_id"];
            ...
            <div class="card-header bg-light bg-gradient row">
                <div class="col-12 col-md-8 col-lg-9">
                    ...
                    if ($data_status == 'delete') {
                        ...
                        echo '<h5 class="card-title mt-2 h3 text-primary">researchs Management</h5>';
                    }
                    ?>
                ...
                <div class="col-6 offset-6 offset-md-0 col-md-4 col-lg-3">
                    <form action="?" method="get">
                        ...
                        <?php
                        $sql_year = "Select Year(jour_date_avaliable) As b_year From research Where jour_status = 'enable' Group By Year(jour_date_avaliable)";
    ...
    public function gen_data_owner($jour_id, $row)
    {
        $fnc = new web;
        $sum_ratio = 0;
    ?>
            ...
            <table class="table table-striped table-bordered table-hover table-inverse table-responsive">
                ...
                <tbody style="font-size: 0.8em;">
                    <tr>
                        ...
                        <td><?= '<a href="?p=research&find=memberId&k=' . $row["jour_owner_citizenid"] . '" target="_top" class="fw-bold">' . $fnc->gen_titlePosition_short($row["jour_owner_prename"]) . $row["jour_owner_firstname"] . ' ' . $row["jour_owner_lastname"] . '</a>' ?></td>
                    ...
                    $sql = "SELECT * FROM `co_worker` WHERE `cow_status` = 'enable' AND `cow_ref_table` = 'research' AND `cow_ref_id` = " . $jour_id;
                    $fnc->debug_console("co worker sql: " . $sql);
                    $co_worker = $fnc->get_db_array($sql);
                    ...
                    ?>
                            <tr>
                                ...
                                <?php
                                if (isset($_GET['act']) && $_GET['act'] == "coWorker") {
                                    $confirm_parameter = "'research'," . $jour_id . "," . $cow["cow_id"];
    ...
    public function gen_data_detail($jour_id)
    {
        $fnc = new web;
    ...
    ?>
        ...
        <?php if (!empty($row["department_name"])) { ?>
            <div class="row mb-3">
                ...
                <?php
                $sql = "Select co_worker.department_name From co_worker Inner Join research On co_worker.cow_ref_id = research.jour_id Where research.jour_id = 10 And co_worker.cow_status = 'enable'";
                ...
                <div class="mb-3 mt-2 col-12 col-md-8">
                    <?php if ($row["jour_attach"] == "true") { ?>
                        ...
                        The current link item
                            ...
                            <?php
                            $sql = "SELECT * FROM `attachment` WHERE `att_status` = 'enable' AND `att_ref_table` = 'research' AND `att_ref_id` = " . $jour_id . " ORDER BY att_filename";
                            ...
                            if (!empty($attachment_file)) {
                                foreach ($attachment_file as $att) {
                                    ...
                                    echo '</div>';
                                    if (isset($_GET['act']) && $_GET['act'] == "coWorker") {
                                        $confirm_parameter = "'research'," . $jour_id . "," . $att["att_id"];
    ...
    <?php $this->gen_data_owner($jour_id, $row);
    ...
    public function gen_data_info($jour_id)
    {
        $fnc = new web;
    ?>
        ...
        <div class="card p-0 p-md-3 box_shadow">
            ...
            <div class="card-body mt-3">
                ...
                <?php $row = $this->gen_data_detail($jour_id); ?>

            </div>

            <div class="card-footer text-end">
                <div class="col mt-3">
                    <button type="button" class="btn btn-outline-secondary px-4 py-2 text-uppercase" onclick="window.open('?p=research');">close</button>
                    <?php if ($row["pro_status"] == 'delete') { ?>
                        <button type="button" class="btn btn-outline-success px-4 py-2 text-uppercase" onclick="window.open('../db_mgt.php?p=research&act=restore&pid=<?= $jour_id ?>','_top');">restore</button>
                    <?php } else { ?>
                        <button type="button" class="btn btn-outline-danger px-4 py-2 text-uppercase" onclick="data_delete_confirmation(<?= 'research,' . $jour_id ?>);">delete</button>
                        <!-- <button type="button" class="btn btn-primary px-4 py-2 text-uppercase">Action</button> -->
                    <?php } ?>
    ...
    public function gen_data_coworker($jour_id)
    {
        $fnc = new web;
    ?>
        ...
        <div class="card p-0 p-md-3 box_shadow">
            ...
            <div class="card-body mt-3">
                ...
                <?php $this->gen_data_detail($jour_id); ?>
            ...
            <div class="card-body row">
                ...
                <div class="col-md-5 offset-md-1 mb-4 mb-md-0">
                    <form action="../db_mgt.php" method="post" autocomplete="off">
                        ...
                        <button type="button" class="btn btn-danger px-4 py-2 text-uppercase">delete</button> -->
                                    ...
                                    <input type="hidden" name="fst" value="researchCoWorkerIntAppend">
                                    <input type="hidden" name="ref_table" value="research">
                ...
                <div class="col-md-5">
                    <form action="../db_mgt.php" method="post" autocomplete="off">
                        ...
                        <button type="button" class="btn btn-danger px-4 py-2 text-uppercase">delete</button> -->
                                    <button type="submit" class="btn btn-outline-primary px-4 py-2 text-uppercase">Add</button>
                                    <input type="hidden" name="fst" value="researchCoWorkerExtAppend">
                                    <input type="hidden" name="ref_table" value="research">
                                    <input type="hidden" name="ref_id" value="<?= $_GET["jid"] ?>">
                                </div>
                            </div>
    ...
    public function gen_data_attachment($jour_id)
    {
        $fnc = new web;
    ?>
        ...
        <div class="card p-0 p-md-3 box_shadow">
            <div class="card-header bg-light bg-gradient row">
                ...
                <div class="col-6 offset-6 offset-md-0 col-md-4 col-lg-3 d-print-none">
                    <form action="?" method="get">
                        ...
                        <?php
                        $sql_year = "Select pro_fiscalyear As fyear From research Where research.pro_status = 'enable' Group By pro_fiscalyear Order By pro_fiscalyear Desc";
            ...
            <div class="card-body mt-3">
                ...
                <table class="table table-striped table-bordered table-inverse table-responsive">
                    ...
                    <tbody style="font-size: 0.85em;">
                        <?php
                        // $sql = "elect jou.* From research jou Left Join co_worker cowo On cowo.cow_ref_id = jou.jour_id Where jou.jour_status Like 'enable' Group By jou.jour_date_avaliable, jou.jour_id Order By jou.jour_date_avaliable Desc";
                        $sql = "Select jou.* From research jou Left Join co_worker cowo On cowo.cow_ref_id = jou.jour_id Where ";
            ...
            <?php if (isset($_GET['fyear']) && $_GET['fyear'] != "") { ?>
                <div class="card-body mt-3">
                    ...
                    <table class="table table-striped table-bordered table-inverse table-responsive">
                        ...
                        <tbody style="font-size: 0.85em;">
                            <?php
                            $sql = "Select pro.* From research pro Left Join co_worker cowo On cowo.cow_ref_id = pro.pro_id Where ";
...
<?php
    ...
    public function gen_report_apa()
    {
        ...
        $data_array = $fnc->get_db_array("SELECT * FROM `research` WHERE `jour_status` = 'enable'");
        ...
        if (!empty($data_array)) {
            ...
            foreach ($data_array as $row) {
                ...
                echo '</td>';
                echo '<td>' . '<a href="?p=research&act=report&cat=apasample&jid=' . $row['jour_id'] . '">' . $row['jour_study'] . '</a>' . '</td>
            </tr>';
            }
        }
        ...
        if (isset($_GET['jid']) && $_GET['jid'] != '') {
            $jid = $_GET['jid'];
            $row = $fnc->get_db_row("SELECT * FROM `research` WHERE `jour_id` = " . $jid);
            if (!empty($row)) {
                echo '<h4>data</h4>';
                ...
                $cow = $fnc->get_db_array("SELECT * FROM `co_worker` WHERE `cow_ref_table` = 'research' AND `cow_ref_id` = " . $jid);
                if (!empty($cow)) {
