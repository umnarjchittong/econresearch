...
class research_fnc
{
            ...
            <form action="../db_mgt.php" method="post" autocomplete="off">
                <div class="card-body mt-3">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="res_name" id="res_name" aria-describedby="res_nameHelp"
                            placeholder="ชื่องานวิจัย/เรื่อง" required>
                        <label for="res_name" class="form-label">ชื่องานวิจัย/เรื่อง <span class="lbl_required">*</span></label>
                    </div>

                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="res_budget_source" id="res_budget_source"
                            aria-describedby="res_budget_sourceHelp" placeholder="แหล่งทุน" required>
                        <label for="res_budget_source" class="form-label">แหล่งทุน <span class="lbl_required">*</span></label>
                    </div>
                    <!-- </div> -->

                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" name="res_budget" id="res_budget"
                            aria-describedby="res_budgetHelp" placeholder="งบประมาณ" min="0" required onblur="calculate_budget_ratio()">
                        <label for="res_budget" class="form-label">งบประมาณ <span class="lbl_required">*</span></label>
                    </div>

                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="res_budget_province" id="res_budget_province"
                            aria-describedby="res_budget_provinceHelp" placeholder="จังหวัด">
                    ...
                    <div class="col-12 mb-3">
                        <div class="row g-3">
                            <div class="col-md-6 form-floating">
                                <input type="date" class="form-control" name="res_period_begin" id="res_period_begin"
                                    aria-describedby="res_period_beginHelp" required>
                                <label for="res_period_begin" class="form-label">วันเริ่มต้นโครงการ <span
                                        class="lbl_required">*</span></label>
                            </div>
                            <div class="col-md-6  form-floating">
                                <input type="date" class="form-control" name="res_period_finish" id="res_period_finish"
                                    aria-describedby="res_period_finishHelp">
                    ...
                    <div class="row mb-3">
                        <div class="col-12 col-md-6 mb-3">
                            <label for="res_period_begin" class="form-label">แหล่งงบประมาณ <span
                                    class="lbl_required">*</span></label>
                            <div class="col-12 mb-3">
                                <div class="form-check form-check-inline ms-2 ms-md-5">
                                    <input class="form-check-input" type="radio" name="res_tier" id="res_tier_1" value="ภายใน"
                                        checked>
                            ...
                            <div class="form-floating col-12 mb-3">
                                <textarea class="form-control" name="res_detail" id="res_detail" rows="10" style="height: 15em;"
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            if (!empty($dept)) { ?>
                                <div class="col-12 mb-3 form-floating">
                                    <select class="form-select" name="department_name" id="department_name"
                                        aria-describedby="department_nameHelp" required>
                                        <?php
                                    ...
                                    <label for="department_name" class="form-label">หลักสูตร/สาขาวิชา <span
                                            class="lbl_required">*</span></label>
                                </div>
                            <?php } ?>
                            ...
                            <?php if ($_SESSION["admin"]["auth_lv"] >= 7) { ?>
                                <div class="col-12 mb-3 form-floating">
                                    <select class="form-select" size="8" style="height: 10em;" name="res_owner_citizenid"
                                        id="res_owner_citizenid" aria-describedby="res_owner_citizenidHelp" required>
                                        <?php
                                        $MJU_API = new MJU_API;
                                    ...
                                    <label for="res_owner_citizenid" class="form-label">Owner <span
                                            class="lbl_required">*</span></label>
                                </div>
                            <?php } else { ?>
                                <div class="col-12 mb-3 form-floating">
                                    <div class="col form-floating">
                                        <input type="hidden" name="res_owner_citizenid" id="res_owner_citizenid"
                                            value="<?= $_SESSION["admin"]["citizenId"] ?>">
                                        <input type="text" class="form-control" name="res_owner_fullname" id="res_owner_fullname"
                                            aria-describedby="res_owner_fullnameHelp"
                                            value="<?= $_SESSION["admin"]["firstName"] . " " . $_SESSION["admin"]["lastName"] . " (" . $fnc->gen_titlePosition_short($_SESSION["admin"]["titlePosition"]) . ")" ?>"
                                            readonly>
                                        <label for="res_owner_fullname" class="form-label">Owner <span
                                                class="lbl_required">*</span></label>
                                    </div>
                                </div>
                            <?php } ?>
                            ...
                            <div class="col-12 mb-3">
                                <div class="col form-floating">
                                    <input type="number" class="form-control" name="res_ratio" id="res_ratio"
                                        aria-describedby="res_ratioHelp" value="100" max="100" maxlength="5" onblur="calculate_budget_ratio()">
                                    <label for="res_ratio" class="form-label">สัดส่วน (%)</label>
                                </div>
                            </div>

                            <script>
                                function calculate_budget_ratio() {
                                    var budget = document.getElementById("res_budget").value;
                                    var ratio = document.getElementById("res_ratio").value;
                                    var total = (budget * ratio) / 100;
                                    console.log("Budget: " + budget + ", Ratio: " + ratio + ", Total: " + total);
                                    document.getElementById("res_budget_researcher").value = total;
                                }
                            </script>

                            <div class="col-12 mb-3">
                                <div class="col form-floating">
                                    <input type="number" class="form-control" name="res_budget_researcher" id="res_budget_researcher"
                                        aria-describedby="res_budget_researcherHelp" max="100" value=""
                                        readonly>
                                    <label for="res_budget_researcher" class="form-label">สัดส่วนงบประมาณต่อนักวิจัยคณะฯ</label>
                                </div>
                            </div>

                            <div class="col-12 text-center">
                                <div class="form-check form-check-inline ms-md-5">
                                    <input class="form-check-input" type="radio" name="res_isLeader" id="res_isLeader_1" value="1">
                                    <label class="form-check-label" for="res_isLeader_1">หัวหน้าโครงการวิจัย</label>
                                </div>
                                <div class="form-check form-check-inline ms-1 ms-md-3">
                                    <input class="form-check-input" type="radio" name="res_isLeader" id="res_isLeader_0" value="" checked>
                                    <label class="form-check-label" for="res_isLeader_0">ผู้ร่วมโครงการวิจัย</label>
                                </div>
                            </div>
        ...
        <div class="card p-0 p-md-3 box_shadow">
            <div class="card-header bg-light bg-gradient row justify-content-between">
                <div class="col-auto">
                    ...
                    <h6 class="card-subtitle mb-1 text-muted" style="font-size: 0.8em;">ปรับปรุงข้อมูล - ข้อมูลงานวิจัย
                        (ภายใน/ภายนอก)</h6>
                </div>
            ...
            <form action="../db_mgt.php" method="post" autocomplete="off">
                <div class="card-body mt-3">
                    ...
                    <div class="col mb-3 form-floating">
                        <input type="text" class="form-control" name="res_budget_source" id="res_budget_source"
                            aria-describedby="res_budget_sourceHelp" value="<?= $row["res_budget_source"] ?>" required>
                        <label for="res_budget_source" class="form-label">แหล่งทุน <span class="lbl_required">*</span></label>
                    </div>

                    <div class="col mb-3 form-floating">
                        <input type="number" class="form-control" name="res_budget" id="res_budget"
                            aria-describedby="res_budgetHelp" value="<?= $row["res_budget"] ?>" onblur="calculate_budget_ratio()">
                        <label for="res_budget" class="form-label">งบประมาณ <span class="lbl_required">*</span></label>
                    </div>

                    <div class="col mb-3 form-floating">
                        <input type="text" class="form-control" name="res_budget_province" id="res_budget_province"
                            aria-describedby="res_budget_provinceHelp" value="<?= $row["res_budget_province"] ?>">
                        <label for="res_budget_province" class="form-label">จังหวัด </label>
                    </div>
                    ...
                    <div class="col-12 mb-3">
                        <div class="row g-3">
                            <div class="col-md-6 form-floating">
                                <input type="date" class="form-control" name="res_period_begin" id="res_period_begin"
                                    aria-describedby="res_period_beginHelp" value="<?= $row["res_period_begin"] ?>" required>
                                <label for="res_period_begin" class="form-label">วันเริ่มต้นโครงการ <span
                                        class="lbl_required">*</span></label>
                            </div>
                            <div class="col-md-6  form-floating">
                                <input type="date" class="form-control" name="res_period_finish" id="res_period_finish"
                                    aria-describedby="res_period_finishHelp" value="<?= $row["res_period_finish"] ?>">
                                <label for="res_period_finish" class="form-label">วันสิ้นสุดโครงการ</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <div class="col-12 mb-3 form-floating">
                                <textarea class="form-control" name="res_detail" id="res_detail" rows="5" style="height: 10em;"
                                    placeholder="(ถ้ามี)"><?= $row["res_detail"] ?></textarea>
                                <label for="res_detail" class="form-label">รายละเอียด</label>
                            </div>

                            <div class="col mb-3 form-floating">
                                <input type="text" class="form-control" name="res_researchCode" id="res_researchCode"
                                    aria-describedby="res_researchCodeHelp" value="<?= $row["res_researchCode"] ?>">
                                <label for="res_researchCode" class="form-label">รหัสงานวิจัย</label>
                            </div>

                            <?php if (isset($_SESSION["admin"]) && $_SESSION["admin"]["auth_lv"] >= 7) { ?>
                                <div class="col mb-3 form-floating">
                                    <input type="text" class="form-control" name="res_researchID" id="res_researchID"
                                        aria-describedby="res_researchIDHelp" value="<?= $row["res_researchID"] ?>">
                                    <label for="res_researchID" class="form-label">รหัส rid <span class="lbl_required">*
                                            สำหรับเจ้าหน้าที่</span></label>
                                </div>
                            <?php } ?>
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            if (!empty($dept)) { ?>
                                <div class="col-12 mb-3 form-floating">
                                    <select class="form-select" name="department_name" id="department_name"
                                        aria-describedby="department_nameHelp">
                                        <?php
                                        $sql = "SELECT * FROM `department` ORDER BY `department_order`, `department_name`";
                                        $data_array = $fnc->get_db_array($sql);
                                        echo '<option value=""';
                            ...
                            <?php } elseif (!empty($row['department_name'])) { ?>
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="department_name" id="department_name"
                                        aria-describedby="department_nameHelp" value="<?= $row["department_name"] ?>" readonly>
                                </div>
                            <?php } ?>

                            <div class="col-12 mb-3 form-floating">
                                <select class="form-select" size="8" style="height: 10em;" name="res_owner_citizenid"
                                    id="res_owner_citizenid" aria-describedby="res_owner_citizenidHelp">
                                    <?php
                                    $MJU_API = new MJU_API();
                                    // $api_url = "https://api.mju.ac.th/Person/API/PERSON9486bba19bca462da44dc8ac447dea9723052020/Department/20500";
                                    $api_url = "https://apissandbox.mju.ac.th/api/v1/person/Department/20500";
                            ...
                            <div class="col-12 mb-3">
                                <div class="col form-floating">
                                    <input type="number" class="form-control" name="res_ratio" id="res_ratio"
                                        aria-describedby="res_ratioHelp" max="100" value="<?= $row["res_ratio"] ?>"
                                        maxlength="5" onblur="calculate_budget_ratio()">
                                    <label for="res_ratio" class="form-label">สัดส่วน (%)</label>
                                </div>
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                <div class="col form-floating">
                                    <input type="number" class="form-control" name="res_budget_researcher" id="res_budget_researcher"
                                        aria-describedby="res_budget_researcherHelp" max="100" value="<?= $row["res_budget_researcher"] ?>"
                                        readonly>
                                    <label for="res_budget_researcher" class="form-label">สัดส่วนงบประมาณต่อนักวิจัยคณะฯ</label>
                                </div>
                            </div>
                            ...
                            <div class="col-12 text-center">
                                <div class="form-check form-check-inline ms-md-5">
                                    <input class="form-check-input" type="radio" name="res_isLeader" id="res_isLeader_1" value="1" <?php if ($row["res_isLeader"] == '1') { echo 'checked'; } ?>>
                                    <label class="form-check-label" for="res_isLeader_1">หัวหน้าโครงการวิจัย</label>
                                </div>
                                <div class="form-check form-check-inline ms-1 ms-md-3">
                                    <input class="form-check-input" type="radio" name="res_isLeader" id="res_isLeader_0" value="" <?php if (!$row["res_isLeader"]) { echo 'checked'; } ?>>
                                    <label class="form-check-label" for="res_isLeader_0">ผู้ร่วมโครงการวิจัย</label>
                                </div>
                            </div>
        ...
        foreach ($data_array as $res) {
            ...
            if (!empty($row)) {
                ...
                <tr>
                    ...
                    ?>
                        <a href="?p=research&act=report&cat=apasample&rid=<?= $row["res_id"] ?>" target="_blank"
                            class="d-print-none"><span class="badge rounded-pill bg-secondary text-white px-2 ms-2 fw-light"
                                style="font-size: 1em;">APA</span></a>
                    </td>
                    <td nowrap>
                        <?php
                    ...
                    <tr>
                        ...
                        <!-- <td class="text-start"><a href="?p=research&act=report&cat=department&d=<? //= $row["department_name"] 
                                ?>" target="_top" class="link-primary fw-bold"><? //= $row["department_name"] 
                                        ?></a></td> -->
                        <td class="text-start"><a href="?p=research&d=<?= $row["department_name"] ?>" target="_top"
                            ...
                            <tr>
                                ...
                                <!-- <td class="text-start"><a href="?p=research&act=report&cat=department&d=<? //= $cow["department_name"] 
                                                ?>" target="_top" class="link-primary fw-bold"><? //= $cow["department_name"] 
                                                                ?></a></td> -->
                                <td class="text-start"><a href="?p=research&d=<?= $cow["department_name"] ?>" target="_top"
                                        class="link-primary fw-bold"><?= $cow["department_name"] ?></a></td>
    ...
    public function gen_data_detail($id)
    {
        ...
        <?php if (isset($_GET["act"]) && $_GET["act"] == "viewinfo") { ?>
            ...
            <?php if (!empty($row["res_budget_researcher"])) { ?>
                <div class="row mb-3">
                    <label class="<?= $label_cls ?>">สัดส่วนงบประมาณต่อนักวิจัย (คณะฯ)</label>
                    <label class="<?= $data_cls ?>"><?= number_format($row["res_budget_researcher"],2) ?> บาท</label>
                </div>
            <?php } ?>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="input-group">
                                <input type="file" class="form-control" name="file_attach[]" id="file_attach"
                                    aria-describedby="inputGroupFileAddon04" aria-label="Upload" accept=".pdf, .jpg, .jpeg, .png"
                                    multiple required>
                                <button class="btn btn-outline-primary text-uppercase" type="submit"
    ...
    public function gen_data_action_menu()
    {
        ...
        if (!empty($fnc->get_db_row($sql)) || $_SESSION["admin"]["auth_lv"] >= 7) {
            ...
            <div class="col-12 col-lg-auto align-self-top text-end fw-bold text-primary" style="font-size:0.75em;">
                <a href="?p=<?= $_GET["p"] ?>&act=viewinfo&rid=<?= $_GET["rid"] ?>" target="_top"
                    class="btn btn-outline-success btn-sm px-3 text-uppercase"
                    style="font-size:1em;"><?= $fnc->icon_set["viewinfo"]; ?>view research info</a>
                <a href="?p=<?= $_GET["p"] ?>&act=coWorker&rid=<?= $_GET["rid"] ?>" target="_top"
                    class="btn btn-outline-success btn-sm px-3 text-uppercase ms-3"
                    style="font-size:1em;"><?= $fnc->icon_set["coworker"]; ?>co-worker/attachment</a>
                <?php if (isset($_GET['act']) && $_GET['act'] == "viewinfo") { ?>
                    <div class="text-end mt-2">
                        <a href="?p=<?= $_GET["p"] ?>&act=update&rid=<?= $_GET["rid"] ?>" target="_top"
                            class="btn btn-outline-primary btn-sm px-3 text-uppercase"
                            style="font-size:1em;"><?= $fnc->icon_set["updateinfo"]; ?>update research info</a>
                    </div>
                <?php } ?>
            </div>
            <?php
                ...
                <div class="col mt-3 me-1">
                    ...
                    if (!empty($fnc->get_db_row($sql)) || $_SESSION["admin"]["auth_lv"] >= 7) {
                        if ($row["res_status"] == 'delete') { ?>
                            <button type="button" class="btn btn-outline-success px-3 py-2 text-uppercase"
                                onclick="window.open('../db_mgt.php?p=research&act=restore&rid=<?= $id ?>','_top');">restore</button>
                        <?php } else { ?>
                            <button type="button" class="btn btn-outline-danger btn-sm px-3 py-2 text-uppercase ms-3"
                                onclick="data_delete_confirmation(<?= "'research'," . $id ?>);"><?= $fnc->icon_set["delete"]; ?>delete
                                research</button>
                            <!-- <button type="button" class="btn btn-primary px-4 py-2 text-uppercase">Action</button> -->
                        <?php }
                    } ?>
        ...
        <div class="card p-0 p-md-3 box_shadow">
            <div class="card-header bg-light bg-gradient row justify-content-between">
                <div class="col-auto">
                    ...
                    <h6 class="card-subtitle mb-1 text-muted" style="font-size: 0.8em;">ข้อมูลงานวิจัย (ภายใน/ภายนอก) -
                        ผู้ร่วมงาน</h6>
                </div>
            ...
            ?>
            <!-- <script>
                function handleAddCoworkerSubmit(event) {
                    event.preventDefault(); // Prevent the default form submission  
                    // Validate the form fields
                    if (!document.getElementById("cow_citizenid").value) {
                        // alert("กรุณาเลือกผู้ร่วมงาน");
                        alertPopUp("warning", "โปรดตรวจสอบ", "กรุณาเลือกผู้ร่วมงาน");
                        return false;
                    }
                    // Check if the selected citizen ID is already a co-worker
                    if (!document.getElementById("cow_ratio").value) {
                        alertPopUp("warning", "โปรดตรวจสอบ", "กรุณากำหนดสัดส่วน (%) ของผู้ร่วมงาน");
                        return false;
                    }
                    // Validate the ratio input
                    if (document.getElementById("cow_ratio").value <= 0 || document.getElementById("cow_ratio").value > 100) {
                        alertPopUp("warning", "โปรดตรวจสอบ", "กรุณากำหนดสัดส่วน (%) ของผู้ร่วมงาน ให้มีค่าระหว่าง 0 - 100");
                        return false;
                    }
                    event.target.submit(); // Submit the form programmatically
                }

                function handleRegisCoworkerSubmit(event) {
                    event.preventDefault(); // Prevent the default form submission  
                    // Validate the form fields
                    if (!document.getElementById("floatingPrename").value) {
                        alertPopUp("warning", "โปรดตรวจสอบ", "กรุณาระบุคำนำหน้า/ตำแหน่งวิชาการ");
                        return false;
                    }
                    // Check if the selected floatingFirstname and floatingLastname is already a co-worker
                    if (!document.getElementById("floatingFirstname").value) {
                        alertPopUp("warning", "โปรดตรวจสอบ", "กรุณาระบุชื่อ");
                        return false;
                    }
                    if (!document.getElementById("floatingLastname").value) {
                        alertPopUp("warning", "โปรดตรวจสอบ", "กรุณาระบุนามสกุล");
                        return false;
                    }
                    // Validate the ratio input
                    if (!document.getElementById("cow_ratio").value) {
                        alertPopUp("warning", "โปรดตรวจสอบ", "กรุณาระบุสัดส่วน (%) ของผู้ร่วมงาน");
                        return false;
                    }
                    if (document.getElementById("cow_ratio").value <= 0 || document.getElementById("cow_ratio").value > 100) {
                        alertPopUp("warning", "โปรดตรวจสอบ", "กรุณากำหนดสัดส่วน (%) ของผู้ร่วมงาน ให้มีค่าระหว่าง 0 - 100");
            ...
            <div class="card-body row">
                ...
                <div class="col-md-5 offset-md-1 mb-4 mb-md-0">
                    <form action="../db_mgt.php" method="post" autocomplete="off" onsubmit="handleAddCoworkerSubmit(event);">
                        <div class="card col-">
                            <div class="card-body p-4">
                                ...
                                <div class="col-12 mb-3">
                                    <label for="cow_citizenid" class="form-label text-capitalize">select co-worker <span
                                            class="lbl_required">*</span></label>
                                    <select class="form-select" size="8" name="cow_citizenid" id="cow_citizenid"
                                        aria-describedby="cow_citizenidHelp" required>
                                        <?php
                                        foreach ($econ_member as $member) {
                                            echo '<option value="' . $member["citizenId"] . '">' . $member["firstName"] . '&nbsp;&nbsp;' . $member["lastName"] . ' (' . $fnc->gen_titlePosition_short($member["titlePosition"]) . ')' . '</option>';
                                        }
                                ...
                                <div class="col-12">
                                    <div class="col">
                                        <label for="cow_ratio" class="form-label">สัดส่วน (%) <span class="lbl_required">*</span></label>
                                        <input type="number" class="form-control" name="cow_ratio" id="cow_ratio"
                                            aria-describedby="cow_ratioHelp" min="1" max="100" maxlength="5" required>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer text-end">
                        ...
                        <button type="button" class="btn btn-danger px-4 py-2 text-uppercase">delete</button> -->
                                    <button type="submit"
                                        class="btn btn-outline-primary btn-sm px-3 py-2 text-uppercase"><?= $fnc->icon_set["coworker_add"] ?>Add</button>
                ...
                <div class="col-md-5">
                    <form action="../db_mgt.php" method="post" autocomplete="off" onsubmit="handleRegisCoworkerSubmit(event);">
                        <div class="card col-">
                            <div class="card-body p-4">
                                <div class="col-12 mb-3">
                                    <label for="res_owner_citizenid" class="form-label text-capitalize">Register a new co-worker
                                        <span class="lbl_required">*</span></label>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control form-control-sm" name="cow_prename"
                                            id="floatingPrename" required>
                                        <label for="floatingPrename">คำนำหน้า/ตำแหน่งวิชาการ <span class="lbl_required">*</span></label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control form-control-sm" name="cow_firstname"
                                            id="floatingFirstname" required>
                                        <label for="floatingFirstname">ชื่อ <span class="lbl_required">*</span></label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="text" class="form-control form-control-sm" name="cow_lastname"
                                            id="floatingLastname" required>
        ...
        <div class="card p-0 p-md-3 box_shadow">
            <div class="card-header bg-light bg-gradient row justify-content-between">
                <div class="col-auto">
                    ...
                    <h6 class="card-subtitle mb-1 text-muted" style="font-size: 0.8em;">ข้อมูลงานวิจัย (ภายใน/ภายนอก) - ไฟล์แนบ
                    </h6>
                </div>
                ...
                <ul class="nav justify-content-start">
                    ...
                    <li class="nav-item d-none">
                        <a class="nav-link<?php if (isset($_GET['cat']) && $_GET['cat'] == 'personal') {
                            ...
                            echo ' link-light';
                        } ?>" href="?act=report&cat=personal-old">รายบุคคล-ตัวอย่าง</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="card p-0 p-md-0 border border-white">
            <div class="card-header bg-light bg-gradient row d-print-none">
                <div class="col-12 col-md-12 col-lg-9 d-print-none">
                    ...
                    // }
                    ?>
                    <h6 class="card-subtitle mb-1 text-muted" style="font-size: 0.8em;">รายงานข้อมูลงานวิจัย
                        (ภายใน/ภายนอก)รายบุคคล</h6>
                </div>
